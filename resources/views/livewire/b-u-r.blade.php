<div>
   ...
   <div class="flex w-[1420px] mx-[270px] mt-[110px] mb-[10px]">
        <div class="w-[1420px] mx-[0px] rounded-lg p-4 relative">
            ...
            <div class="flex flex-col gap-y-[5px] text-indigo-800 text-[25px] font-extrabold font-['Inter'] leading-5">Budget Utilization Request
                ...
                <div class="flex ml-[835px] mt-[-50px] items-start">
                    @include('livewire.bur-import-export-add')
                </div>
            </div>
        </div>
    </div>

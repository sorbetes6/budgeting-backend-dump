            ...
            <form class="space-y-2" action="#">
                <div class="h-6 flex-col justify-start items-start flex">
                    ...
                    <div class="flex-grow-0 flex-shrink-0">
                        <input type="cost-student" name="cost-student" id="cost-student" class="w-[550px] h-8 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center inline-flex focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight" placeholder="Description" />
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="flex my-5 w-[1200px]">
        ...
        <div class="w-[220px] h-24 px-4 py-3.5 bg-white rounded-xl shadow border border-zinc-200 flex-col justify-start items-start inline-flex">
            <form class="space-y-2" action="#">
                ...
                <div class="flex-grow-0 flex-shrink-0">
                    <input type="cost-student" name="cost-student" id="cost-student" class="w-40 h-8 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight" placeholder="Description" />
                </div>
            </form>
        </div>
        <!--Card 4-->
        ...
        <div class="w-[220px] h-24 px-4 py-3.5 bg-white rounded-xl shadow border border-zinc-200 flex-col justify-start items-start gap-2.5 inline-flex ml-[25px]">
            <form class="space-y-2" action="#">
                ...
                <div class="flex-grow-0 flex-shrink-0">
                    <input type="cost-student" name="cost-student" id="cost-student" class="w-40 h-8 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight" placeholder="₱0.00" />
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="flex my-5 w-[1200px]">
        ...
        <div class="w-[220px] h-24 px-4 py-2 bg-white rounded-xl shadow border border-zinc-200 flex-col justify-start items-start gap-2.5 inline-flex">
            <form class="space-y-2" action="#">
                ...
                <div class="flex-grow-0 flex-shrink-0">
                    <input type="cost-student" name="cost-student" id="cost-student" class="w-40 h-8 px-3 py-2 bg-white rounded-md shadow border border-zinc-200 justify-start items-center gap-2 inline-flex focus:ring-blue-500 focus:border-blue-500 text-zinc-500 text-sm font-normal font-['Inter'] leading-tight" placeholder="0" />
                </div>
            </form>
        </div>
        <!--Card 4-->

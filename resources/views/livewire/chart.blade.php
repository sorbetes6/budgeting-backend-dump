<div>
    ...
    <aside id="logo-sidebar" class="fixed top-8 left-0 z-40 w-75 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div class="h-full px-4 pb-4 overflow-y-auto bg-indigo-800 dark:bg-gray-800 ">
            ...
            <ul class="space-y-1 font-medium w-78 h-10 flex-col top-4 justify-start items-start inline-flex">

                <li>
                    <a href="#" class="w-56 px-2 py-1 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                ...
                <div class="relative inline-block">
                    ...
                    <ul id="dropdown" class="absolute hidden bg-white text-gray-800 border rounded-md mt-2">
                        <li class="px-4 py-2 hover:bg-gray-200">Activity Justification</li>
                        <li class="px-4 py-2 hover:bg-gray-200">Personal Services</li>
                        <li class="px-4 py-2 hover:bg-gray-200">Personnel Schedule</li>
                        <li class="px-4 py-2 hover:bg-gray-200">MOOE</li>
                        <li class="px-4 py-2 hover:bg-gray-200">Capital Outlay</li>
                        <li class="px-4 py-2 hover:bg-gray-200">PPMP</li>
                        <!-- Add more li elements for additional options -->
                    </ul>
                </div>
                ...
                <li>
                    <a href="#" class="flex-w-50 px-2 py-1 mt-[400px] flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
    ...
    <!-- WELCOME! -->
    <div class="relative w-[500px] h-80 rounded-lg shadow border border-gray border-opacity-20 bg-cover bg-center ml-[280px] mt-[92px]" style="background-image: url('css/images/background.png')">

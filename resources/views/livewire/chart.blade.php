...
<div>
    ...
    <div class="flex flex-col items-center w-[350px] h-[320px] rounded-lg shadow border border-gray border-opacity-20 ml-[1330px] mt-[22px]">
        <div class="flex items-center">
            <button id="prevMonth" class="flex items-center justify-center w-5 h-10 rounded-lg shadow border border-gray border-opacity-20 mt-1 text-black font-bold py-5 px-5 rounded">&lt;</button>
            <h1 id="currentMonth" class="text-2xl font-bold mb-3 mt-4 ml-[70px] mr-[70px]">February</h1>
            <button id="nextMonth" class="flex items-center justify-center w-5 h-10 rounded-lg shadow border border-gray border-opacity-20 mt-1 ml-2 text-black font-bold py-5 px-5 rounded">&gt;</button>
        </div> 

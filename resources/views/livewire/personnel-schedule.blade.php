            ...
            <table class="w-[1360px]">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">0</td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">Description</td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">Chief</td>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle" colspan="2"><strong style="font-weight: 900;">CY 2023 Actual Salary/Annum</strong></td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">1,000,000.00</td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle"><strong style="font-weight: 900;">CY 2024 Proposed Salary/Annum</strong></td>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle" colspan="2"><strong style="font-weight: 900;">Increase</strong></td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">0</td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle"><strong style="font-weight: 900;">Increase</strong></td>
                        <td class="border border-gray-300 px-4 py-2 text-start align-middle">
                            <div class="flex items-center">
                                <div class="text-center flex-grow">
                                    0
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle" colspan="2"><strong style="font-weight: 900;">Sub-Total</strong></td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">1,000,000</td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle"><strong style="font-weight: 900;">Sub-Total</strong></td>
                        <td class="border border-gray-300 px-4 py-2 text-start align-middle">
                            <div class="flex items-center">
                                <div class="text-center flex-grow">
                                    1,000,000
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle" colspan="2"><strong style="font-weight: 900;">Total</strong></td>
                        <td class="border border-gray-300 px-4 py-2 text-center align-middle">1,000,000</td>
